...
#Generate cartesian product of all pronoun combinations, add into list for use in later query
...
def main(): 
    conn = sqlite3.connect('../../etc/database_store/new_tweets.db')
