...
bad_words = ['queer', 'gimp', 'slut', 'whore', 'fag', 'faggot', 'fags', 'fudgepacker', 'fudge+packer', 'poof','poofter', 'pansy', 'sissy', 'bender', 'batty', 'ponce', 'jiggalo', 'dyke', 'rug+muncher', 'lesbo', 'tranny', 'trannie', 'transvestite', 'ladyboy', 'trap', 'HeShe', 'shemale', 'bitch', 'switch+hitter']
